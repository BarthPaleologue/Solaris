...
<head>
    ...
    <title>Solaris Project - Jupiter and its satellites</title>
    <meta charset="utf-8" />
...
<body id="corps">
    <h1 id="titre">Solaris Project<br/><span class="soustitre">Jupiter and its Satellites</span></h1>
...
<script src="jupiter-data-en.js"></script>
<script src="../solaris_algorithm.js"></script>
<link rel="stylesheet" href="../common-style.css" />
<link rel="stylesheet" href="../../jquery-ui/jquery-ui.css" />
<script>setTimeout(function(){createScene("high")},100);</script> 