...
<head>
    ...
    <title>Projet Solaris - Jupiter et ses satellites</title>
    <meta charset="utf-8" />
...
<body id="corps">
    <h1 id="titre">Projet Solaris<br/><span class="soustitre">Jupiter et ses Satellites</span></h1>
...
<script src="jupiter-data.js"></script>
<script src="../solaris_algorithm.js"></script>
<link rel="stylesheet" href="../common-style.css" />
<link rel="stylesheet" href="../../jquery-ui/jquery-ui.css" />
<script>setTimeout(function(){$('.text').html('Lancement');createScene("high")},100);</script> 
