...
<head>
    ...
    <title>Projet Solaris - Mars (Il y a 4 milliards d'années d'années)</title>
    <meta charset="utf-8" />
...
<body id="corps">
    <h1 id="titre">Projet Solaris<br/><span class="soustitre">Mars Habitable</span></h1>
    ...
    <script type='module'>
        ...
        initSolaris("./mars-data.json", "high");
    </script>
    <script>
