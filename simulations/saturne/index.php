...
<head>
    ...
    <title>Projet Solaris - Saturne et ses satellites</title>
    <meta charset="utf-8" />
...
<body id="corps">
    <h1 id="titre">Projet Solaris<br/><span class="soustitre">Saturne et ses Satellites</span></h1>
    ...
    <script type='module'>
        ...
        initSolaris("./saturne-data.json","high");
    </script>
    <script>
