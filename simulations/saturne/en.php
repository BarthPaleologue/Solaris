...
<head>
    ...
    <title>Solaris Project - Saturn and its satellites</title>
    <meta charset="utf-8" />
...
<body id="corps">
    <h1 id="titre">Solaris Project<br/><span class="soustitre">Saturn and its Satellites</span></h1>
    ...
    <script type='module'>
        ...
        initSolaris("./saturne-data-en.json","high");
    </script>
    <script>
