...
<head>
    ...
    <title>Solaris Project - Moon and Earth</title>
    <meta charset="utf-8" />
...
<body id="corps">
    <h1 id="titre">Solaris Project<br/><span class="soustitre">Moon and Earth</span></h1>
    ...
    <script type='module'>
        ...
        initSolaris("./earth-moon-data-en.json","high");
    </script>
    <script>
